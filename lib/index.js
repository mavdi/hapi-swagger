...
internals.getRoutesData = function (routes) {
    ...
    routes.forEach(function (route) {
        ...
        routesData.push({
            auth: route.settings.auth && route.settings.auth.strategies[0],
            path: route.path,
...
internals.buildAPIInfo = function( settings, apiData, slug ){
    var parts,
        ...
        if(/(isAuthenticated|isValidApp)/.test(route.auth)) {
            api.operations[0].parameters.push({
              "name": "appid",
              "description": "appid",
              "paramType": "header",
              "required": true,
        ...
        if(/isAuthenticated/.test(route.auth)) {
            api.operations[0].parameters.push({
              "name": "token",
              "description": "Token",
              "paramType": "header",
...
internals.getParamsData = function (params) {
    ...
    for (var i = 0, il = keys.length; i < il; ++i) {
        ...
        console.log(key, Object.keys(param._valids._set)[0] != 'undefined')
        paramsData.push({
            name: key,
            ...
            type: param._type,
            required: Object.keys(param._valids._set)[0] != 'undefined',
